...
<div class="solyan">
<ul>
  <a href="admin.php"><li><img src="../fotolarim\ampulkoyu.png" class="iconlarim"><span class="yazi">Soruları Listele</span></li></a>
  <a href="kullanicilar.php"><li><img src="../fotolarim\pusulakoyu.png" class="iconlarim"><span class="yazi">Kullanicilari Listele</span></li></a>
</ul>
</div>
