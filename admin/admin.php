...
header("Location:anasayfa.php");
   ...
   $getir=mysqli_query($baglan,"SELECT * FROM kullanicilar INNER JOIN sorusor
     ON kullanicilar.kullanici_id=sorusor.kullanici_id where sorusor.Soru_id order by zaman desc");
...
<div class="" style="width:500px; float:left;">
    ...
    <span class="hakkinda">hakkında soru sordu</span><div style="float:right;"><a href="sorusil.php?soru_id=<?php echo $goster['Soru_id'] ?>">SİL</a> </div>
  </div>
